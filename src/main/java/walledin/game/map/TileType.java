...
public enum TileType {
    TILE_EMPTY(' ', false), TILE_FILLED('#', true), TILE_TOP_GRASS_END_LEFT(
            'C', true), TILE_TOP_GRASS_END_RIGHT('D', true), TILE_TOP_GRASS(
            'E', true), TILE_LEFT_GRASS('F', true), TILE_LEFT_MUD('G', true), TILE_RIGHT_MUD(
            'H', true), TILE_TOP_LEFT_GRASS('I', true), TILE_BOTTOM_LEFT_MUD(
            'J', true), TILE_BOTTOM_RIGHT_MUD('K', true), TILE_TOP_LEFT_GRASS_END(
            'L', true), TILE_BOTTOM_MUD('M', true);
